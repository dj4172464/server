...
int LuaUnit::IsInAccessiblePlaceFor(lua_State* L, Unit* unit)
{
    ...
    sEluna.PushBoolean(L, unit->isInAccessablePlaceFor(creature));
    return 1;
}
...
int LuaUnit::HasAura(lua_State* L, Unit* unit)
{
    ...
    //sEluna.PushBoolean(L, player->HasAura(spell, caster ? caster->GetGUIDLow() : 0));
    return 1;
}
...
int LuaUnit::GetCreatorGUID(lua_State* L, Unit* unit)
{
    ...
    //sEluna.PushULong(L, unit->GetCreatGetCreatorGuid());
    return 1;
}
...
int LuaUnit::HasPendingBind(lua_State* L, Unit* unit)
{
    ...
    //sEluna.PushBoolean(L, player->PendingHasPendingBind());
    return 1;
}
...
int LuaUnit::GetHealthPct(lua_State* L, Unit* unit)
{
    ...
    sEluna.PushFloat(L, unit->GetHealthPercent());
    return 1;
}
